...
//        setStyle(DialogFragment.STYLE_NORMAL,R.style.AppCustomDialog);
    ...
    private void setStyle() {
        ...
        //设置偏移量
        wlp.x = SizeUtils.dip2px(getDialog().getContext(), mOffsetX);
        wlp.y = SizeUtils.dip2px(getDialog().getContext(), mOffsetY);
        //设置动画
