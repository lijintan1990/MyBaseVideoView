...
import com.xsl.culture.mybasevideoview.model.PayResult;
    ...
    public void getPayResult(String key) {
        ObtainNetWorkData.getPayResult(new Callback<PayResult>() {
            ...
            public void onResponse(Call<PayResult> call, Response<PayResult> response) {
                ...
                if (payInterface != null) {
                    Log.i(TAG, "zhifubao pay result header: " + response.headers().toString());
                    Log.i(TAG, "zhifubao pay result body: " + response.body().toString());
                    Log.i(TAG, "zhifubao pay result data: " + response.code());
